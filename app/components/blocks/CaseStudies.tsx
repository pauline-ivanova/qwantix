...
const caseStudiesRu = [
    ...
    },
    {
        ...
        description: "Контент полагался на прямой перевод и плохо работал вне английского рынка. Мы переработали страницы под локальный поисковый интент в EN, ES и DE, улучшив поведенческие метрики и видимость по сравнению с буквальными переводами.",
